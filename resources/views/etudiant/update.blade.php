              ...
              <hr>   
                ...
                <form action="/update/traitement" method="POST" class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Noms" name="Noms"  value="{{$etudiants->Noms}}">
                    
                    </div>
                    <div class="form-group">
                        <label for="Prenoms">Prenoms</label>
                        <input type="text" class="form-control" id="Prenoms" name="Prenoms"  value="{{$etudiants->Prenoms}}">
